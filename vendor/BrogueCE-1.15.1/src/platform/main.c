...
#ifdef BROGUE_IPC
    /* brogue-bot: machine-driven play over pipes; env selection keeps all
       command-line behavior identical for human-facing platforms */
    if (getenv("BROGUE_IPC_OUT")) {
        currentConsole = ipcConsole;
    }
#endif
